...
<div class="form-group">
    <label>Fecha</label>
    <input type="date" class="form-control" name="fecha" id="fecha" value="{{ old('fecha', $ingreso->fecha) }}">
</div>

<div class="form-group">
    <label>Proveedor</label>
    <input type="text" class="form-control" name="proveedor" id="proveedor" value="{{ old('proveedor', $ingreso->proveedor) }}">
</div>

<div class="form-group">
    <label>Glosa</label>
    <input type="text" class="form-control" name="glosa" id="glosa" value="{{ old('glosa', $ingreso->glosa) }}">
</div>
